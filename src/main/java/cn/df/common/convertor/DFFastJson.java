package cn.df.common.convertor;

import cn.df.common.utils.base.RtnCodeEnum;
import cn.df.common.utils.sys.ResponseT;
 ...
 */
public class DFFastJson<T> extends AbstractHttpMessageConverter<T> {
